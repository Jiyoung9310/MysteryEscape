...
export const INITIAL_GAME_STATE: GameState = {
  ...
  inventory: [],
  roomStates: {
    isDeskDrawerLocked: true,
    isSafeHidden: true,
    isSafeLocked: true,
    isMainDoorLocked: true,
    hasReadDiary: false,
    hasFoundNoteInPen: false,
  },
  gameWon: false,
};

export const INITIAL_NARRATIVE = "정신을 차려보니 낯선 서재의 안락의자에 앉아 있습니다. 마지막으로 기억나는 것은 쏟아지는 비와 흐릿한 자동차 헤드라이트 불빛뿐입니다. 머리가 지끈거립니다. 방은 어둡고 조용하며, 타다 남은 장작이 온기를 내뿜는 벽난로만이 유일한 빛입니다. 육중한 참나무 문은 굳게 닫혀 있습니다. 어떻게 이곳에 왔는지, 그리고 어떻게 나갈 수 있을지 알아내야 합니다.";

// FIX: Replaced inner backticks with single quotes to prevent template literal parsing errors.
